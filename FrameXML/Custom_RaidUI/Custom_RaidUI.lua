RegisterForSavePerCharacter("RAID_PULLOUT_POSITIONS");
RegisterForSavePerCharacter("RAID_SINGLE_POSITIONS");
...
function RaidGroupFrame_Update()
	...
	RaidFrameAllAssistCheckButton:SetShown(numRaidMembers > 0);
